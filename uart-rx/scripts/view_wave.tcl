# File: view_wave.tcl
# Description: Script to open waveform viewer in Vivado for UART RX
...
set wdb_file [file join $project_dir "uart_rx_sim.wdb"]
if {![file exists $wdb_file]} {
    # Try logs directory
    set wdb_file [file join $log_dir "uart_rx_sim.wdb"]
    if {![file exists $wdb_file]} {
...
add_wave /uart_rx_uvm_tb/clk
add_wave /uart_rx_uvm_tb/vif/rst_n
add_wave /uart_rx_uvm_tb/vif/rx_in
add_wave /uart_rx_uvm_tb/vif/rx_data
add_wave /uart_rx_uvm_tb/vif/rx_data_valid
add_wave /uart_rx_uvm_tb/vif/frame_active
add_wave /uart_rx_uvm_tb/vif/error_detected
add_wave /uart_rx_uvm_tb/vif/framing_error
add_wave /uart_rx_uvm_tb/vif/parity_error
add_wave /uart_rx_uvm_tb/vif/break_detect
add_wave /uart_rx_uvm_tb/dut/*
